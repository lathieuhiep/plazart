    ...
    <div class="bug-content">
        ...
        <div id="errorboxbody">
            <ul class="back-to-homepage">
                <li><a href="<?php echo esc_url(get_home_url('/')); ?>" title="<?php echo esc_html__('Go to the Home Page', 'plazart-theme'); ?>"><?php echo esc_html__('Go to the Home Page', 'plazart-theme'); ?></a></li>
            </ul>
            <div id="techinfo">
                <p>
                </p>
